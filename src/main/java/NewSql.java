...
public class NewSql {//
    ...
    public void renameSql(String name, String newName) throws SQLException {//
        statement.executeUpdate("update Cat set Name = '" + newName + "'  where Name like '" + name+"';");//
    }//


    public void renameSql(String name, int newHealth, int newDamage) throws SQLException {//
        statement.executeUpdate("update Cat set Health = " + newHealth + "set Demage = " + newDamage + "  where Name like '" + name+"';");//
    }


    public void deleteSql(String name) throws SQLException {

        statement.executeUpdate("delete from Cat where Name like '" + name+"';");
    }
